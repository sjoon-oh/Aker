...
namespace topkache
{
    ...
    ResultCacheStats::ResultCacheStats() noexcept
    {
        ...
        stat_level_0["insertWLEntry3"]      = std::vector<ElapsedPair>();
        ...
        stat_level_1["insertWLEntry3-1"]    = std::vector<ElapsedPair>();
        stat_level_1["insertWLEntry3-2"]    = std::vector<ElapsedPair>();
        stat_level_1["insertWLEntry3-3"]    = std::vector<ElapsedPair>();
        stat_level_1["insertWLEntry3-4"]    = std::vector<ElapsedPair>();
        ...
        stat_level_2["_incrBatchUpdateWLog2-1"] 
                                            = std::vector<ElapsedPair>();
        stat_level_2["_incrBatchUpdateWLog2-2"] 
                                            = std::vector<ElapsedPair>();
        stat_level_2["_incrBatchUpdateWLog2-3"] 
                                            = std::vector<ElapsedPair>();
        stat_level_2["_incrBatchUpdateWLog2-4"] 
                                            = std::vector<ElapsedPair>();
