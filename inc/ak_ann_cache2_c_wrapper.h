#ifndef AKER_ANNCACHE2_CWRAPPER_H
#define AKER_ANNCACHE2_CWRAPPER_H
...
} ann_cache_parameter_c_t;


typedef struct ANNCache2CWrapper
{
    char*                               result_cache;
...
ann_cache_2_c_wrapper_t*             create_ann_cache_2_c_wrapper(ann_cache_parameter_c_t parameter);
void                                    destroy_ann_cache_2_c_wrapper(
...
uint64_t                                get_vector_id_entry_2_c_wrapper(
                                            char* searched_entry
                                        );
uint64_t                                get_vector_id_vector_slot_c_wrapper(
                                            char* vector_2_wrapper
                                        );

uint64_t                                get_vector_id_vector_view_c_wrapper(
                                            char* float_vector_2_wrapper
                                        );

char*                                   get_vector_data_vector_slot_c_wrapper(
                                            char* vector_2_wrapper
                                        );
void                                    set_distance_vector_slot_c_wrapper(
                                            char* vector_2_wrapper,
                                            float distance
                                        );
void                                    destroy_vector_slot_c_wrapper(
                                            char* vector_2_wrapper
                                        );
...
void                                    destroy_vector_view_c_wrapper(
                                            char* float_vector_2_wrapper
                                        );
...
void                                    export_call_c_wrapper(ann_cache_2_c_wrapper_t* wrapper);
