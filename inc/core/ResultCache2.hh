...
namespace topkache
{
    ...
    public:
        ...
        size_t                                      cache_dropout;
        size_t                                      cache_refreshed;
        size_t                                      cache_invalid;
        ...
        std::vector<float>                          global_threshold_history;
    ...
    private:
        ...
        // Get random integer in [0, 100)
        inline int getRandomInt(int min = 0, int max = 100) noexcept
        {
        ...
        std::unique_ptr<DdfWriteLog>                ddf_write_log;
    ...
    public:
        ...
        // void                                        releaseCEntry(result_cache_entry_t* entry) noexcept;

        // void                                        incrBatchUpdateWLog(
        //                                                 result_cache_entry_t* saved_entry,
        //                                                 distance_function_t distance_function) noexcept;
        ...
        bool                                        insertCEntry2(
                                                        ...
                                                        // bool                                        insertCEntryLin(
        //                                                 vector_id_t vector_id, result_cache_entry_t* entry,
        //                                                 distance_function_t distance_function) noexcept;
        // bool                                        insertCEntryApprx(
        //                                                     vector_id_t vector_id, result_cache_entry_t* entry,
        //                                                     float_qvec_t query_vector_data, 
        //                                                     distance_function_t distance_function) noexcept;
        ...
        // void                                        packApprxFilter() noexcept;

        // void                                        insertWLEntry(Vector2& write_vector) noexcept;
        // void                                        insertWLEntry2(float_qvec_t write_vector,
        //                                                 distance_function_t distance_function) noexcept;
        void                                        handleAgedWLEntry(distance_function_t distance_function) noexcept;
        ...
        void                                        setDistanceFunction(distance_function_t distance_function) noexcept;
