        ...
        for fixed_threshold_value in "${fixed_threshold[@]}"; do
            for start_threshold_value in "${start_threshold[@]}"; do
                ...
                #     for alpha_loosen_value in "${alpha_loosen[@]}"; do
                        ...
                        result_file_dir="$working_path/4-results/topkache-spacev/${workload_name}/${vector_pool_size_value}-${fixed_threshold_value}-${start_threshold_value}-${alpha_tighten_value}-${alpha_loosen_value}"
