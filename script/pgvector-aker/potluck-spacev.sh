...
write_topkache_config() {
    ...
    echo "{
        ...
        \"risk_threshold\": ${alpha_loosen_value},
            ...
            for start_threshold_value in "${start_threshold[@]}"; do
                for alpha_tighten_value in "${alpha_tighten[@]}"; do
                    for alpha_loosen_value in "${alpha_loosen[@]}"; do
                        ...
                        result_file_dir="$working_path/4-results/potluck-spacev/${workload_name}/potluck-${vector_pool_size_value}-${fixed_threshold_value}-${start_threshold_value}-${alpha_tighten_value}-${alpha_loosen_value}"
